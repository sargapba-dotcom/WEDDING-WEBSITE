            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {[
                ...
                <div key={person.name} className="card-soft rounded-2xl px-6 py-8 text-center">
                  ...
                  <h3 className="text-script mt-3 text-3xl text-primary">{person.name}</h3>
                  <p className="mt-4 text-xs tracking-[0.25em] text-muted-foreground uppercase">
                    {person.rel}
                  </p>
                  <p className="mt-2 text-lg text-foreground">{person.parents[0]}</p>
                  <p className="text-gold text-sm">&amp;</p>
                  <p className="text-lg text-foreground">{person.parents[1]}</p>
                </div>
              ))}
            </div>
          </div>
